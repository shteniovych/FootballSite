...
namespace FC_B13.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(FootballTeamContext context)
        {
            _context = context;
        }
        ...
        {
            var context = _context.Team.Include(p => p.Inventar);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TeamId,NameTeam")] Team team)
        {
            if (id != team.TeamId)
            {
                return NotFound();
